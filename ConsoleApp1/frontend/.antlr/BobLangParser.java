...
public class BobLangParser extends Parser {
	...
	public BobLangParser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public List<TerminalNode> NEWLINE() { return getTokens(BobLangParser.NEWLINE); }
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(BobLangParser.INT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
